...
export default function BlogPost() {
  ...
  const articleSchema = {
    ...
    "image": meta.heroImage ? `https://hellonobi.com${meta.heroImage}` : undefined,
    "author": { "@type": "Person", "name": meta.author || "Nobi Team" },
    "publisher": {
      "@type": "Organization",
      "name": "Nobi",
      "url": "https://hellonobi.com",
    },
    "mainEntityOfPage": { "@type": "WebPage", "@id": `https://hellonobi.com/blog/${post.slug}` },
